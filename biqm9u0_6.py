...
from utils import Mol_Object, read_xyz
...
class BIQM9U0_6(InMemoryDataset):
    def __init__(self, root = '.', input_sdf = './sdfs/qm9U0_std.sdf', transform = None, pre_transform = None, pre_filter = None):
        ...
        super(BIQM9U0_6, self).__init__(root, transform=transform, pre_transform=pre_transform)
    ...
    def process(self):
        ...
        mol_list = read_xyz(self.input_sdf)[:10000]
        datas = paralle(mol_list)
        
        torch.save(self.collate(datas),self.processed_dir +'/bi_' + self.prefix + '_6.pt')
        print('done')
...
if __name__=='__main__':
    ...
    dataset = BIQM9U0_6(input_sdf='./raw/qm9U0_std.xyz')
